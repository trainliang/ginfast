...
func setupEduTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(
		...
		&models.EduScheduleRule{},
		&models.EduScheduleRuleWeekday{},
		&models.EduLesson{},
		&models.EduLessonChangeLog{},
		&models.EduLessonCompletionRule{},
		&models.EduLessonStudentCompletion{},
		&models.EduScheduleConflictOverride{},
		&models.EduStudent{},
